...
4. Add functions to ***.R*** files in the ***R folder***:
    ...
    - use template .R file or template documentation, or documentation referencing 
...
### Create a Template .R File ([Ref](https://stackoverflow.com/questions/35158708/how-to-set-default-template-for-new-r-files-in-rstudio))
...
2. Then create a `default.R` file
    - `cd template`
    - `touch default.R`
    - `open default.R` and add to the template.R file
